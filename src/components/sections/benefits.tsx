    ...
    <section className="py-10 md:py-16 bg-white dark:bg-zinc-950 border-y border-zinc-200 dark:border-zinc-900">
      <div className="container px-4 mx-auto max-w-4xl">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold font-headline uppercase mb-6">
          ...
          <div className="bg-zinc-100 dark:bg-zinc-900 p-6 md:p-8 border-l-4 border-primary">
            <h3 className="text-lg md:text-xl font-bold uppercase mb-4">O que você recebe</h3>
            <ul className="space-y-3 text-sm md:text-base text-zinc-600 dark:text-zinc-400">
